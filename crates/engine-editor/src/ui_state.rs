    ...
    fn component_to_ai_context(component: &engine_ecs::ComponentData) -> serde_json::Value {
        ...
        match component {
            ...
            ComponentData::Light(l) => serde_json::json!({
                ...
                "temperature_kelvin": l.temperature_kelvin,
                "contact_shadow_strength": l.contact_shadow_strength,
                ...
                "shadow_fade_start": l.shadow_fade_start,
                "shadow_max_distance": l.shadow_max_distance,
                "cull_mask": l.cull_mask,
                "shadow_caster_mask": l.shadow_caster_mask,
                "bake_mode": format!("{:?}", l.bake_mode),
                "directional_shadow_mode": format!("{:?}", l.directional_shadow_mode),
                "directional_shadow_blend_splits": l.directional_shadow_blend_splits,
                "directional_shadow_split_1": l.directional_shadow_split_1,
                "directional_shadow_split_2": l.directional_shadow_split_2,
                "directional_shadow_split_3": l.directional_shadow_split_3,
            ...
            ComponentData::Environment(e) => serde_json::json!({
                "type": "Environment",
                "sky_enabled": e.sky_enabled,
                "sky_zenith_color": e.sky_zenith_color,
                "sky_horizon_color": e.sky_horizon_color,
                "sky_rotation_degrees": e.sky_rotation_degrees,
                "sky_intensity": e.sky_intensity,
                "ambient_color": e.ambient_color,
                "ambient_intensity": e.ambient_intensity,
                "fog_enabled": e.fog_enabled,
                "fog_density": e.fog_density,
                "fog_color": e.fog_color,
                "exposure": e.exposure,
                "tonemap": e.tonemap,
                "bloom_enabled": e.bloom_enabled,
                "bloom_intensity": e.bloom_intensity,
                "ssao_enabled": e.ssao_enabled,
                "ssao_radius": e.ssao_radius,
                "ssao_intensity": e.ssao_intensity,
                "ssgi_enabled": e.ssgi_enabled,
                "ssgi_radius": e.ssgi_radius,
                "ssgi_intensity": e.ssgi_intensity,
                "ssr_enabled": e.ssr_enabled,
                "ssr_intensity": e.ssr_intensity,
            }),
