...
impl ComponentSchemaRegistry {
    ...
    pub fn builtin() -> Self {
        ...
        registry.register(ComponentSchema {
            type_id: "Environment".to_string(),
            display_name: "Environment".to_string(),
            version: 1,
            fields: vec![
                field("sky_enabled", ComponentFieldKind::Bool, "true"),
                field("sky_cubemap", ComponentFieldKind::AssetRef, ""),
                field(
                    "sky_zenith_color",
                ...
                field("sky_rotation_degrees", ComponentFieldKind::F32, "0"),
                field("sky_intensity", ComponentFieldKind::F32, "1"),
                field("ambient_color", ComponentFieldKind::Vec3, "0.03,0.035,0.04"),
                field("ambient_intensity", ComponentFieldKind::F32, "1"),
                field("fog_enabled", ComponentFieldKind::Bool, "false"),
                field("fog_density", ComponentFieldKind::F32, "0.0003"),
                field("fog_color", ComponentFieldKind::Vec3, "0.6,0.7,0.85"),
                field("exposure", ComponentFieldKind::F32, "1"),
                field("tonemap", ComponentFieldKind::String, "aces"),
                field("bloom_enabled", ComponentFieldKind::Bool, "true"),
                field("bloom_intensity", ComponentFieldKind::F32, "0.04"),
                field("ssao_enabled", ComponentFieldKind::Bool, "true"),
                field("ssao_radius", ComponentFieldKind::F32, "0.035"),
                field("ssao_intensity", ComponentFieldKind::F32, "1"),
                field("ssgi_enabled", ComponentFieldKind::Bool, "true"),
                field("ssgi_radius", ComponentFieldKind::F32, "2.25"),
                field("ssgi_intensity", ComponentFieldKind::F32, "0.78"),
                field("ssr_enabled", ComponentFieldKind::Bool, "true"),
                field("ssr_intensity", ComponentFieldKind::F32, "0.35"),
            ],
            evolution: SchemaEvolution::default(),
        });
        registry.register(ComponentSchema {
