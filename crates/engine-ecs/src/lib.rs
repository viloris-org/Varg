...
pub use scene::{
    ...
    FluidVolumeComponentData, GameObject, LifecycleStage, Light2DComponentData, LightBakeMode,
    LightComponentData, LightKind, MaterialRef, MeshRendererComponentData, ObjectIdAllocator,
    Occluder2DComponentData, ParticleEmitterComponentData, RigidbodyComponentData,
    SCENE_FILE_VERSION, Scene, SceneFile, SceneMode, ScriptComponent, SerializedGameObject,
